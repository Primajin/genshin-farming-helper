...
const characterWeaponEnhancementMaterialNames = new Set(genshinDb.crafts('Character and Weapon Enhancement Material', defaultOptions).map(material => material?.name));
const allMaterials = genshinDb.materials('names', defaultOptions);
const characterWeaponEnhancementMaterials = allMaterials.filter(material => characterWeaponEnhancementMaterialNames.has(material?.name));
